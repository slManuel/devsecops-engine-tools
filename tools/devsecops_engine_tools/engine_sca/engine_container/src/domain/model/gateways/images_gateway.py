...
class ImagesGateway(metaclass=ABCMeta):
    ...
    @abstractmethod
    def get_base_image(self, image_to_scan, base_image_labels: list) -> str:
        "get base image"

    @abstractmethod
    def validate_base_image_date(self, image_to_scan, referenced_date, base_image_labels: list) -> str:
